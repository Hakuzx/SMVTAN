...
parser.add_argument("--config", type=str, default='config/PEMS04.json',help='configuration file')
...
parser.add_argument("--model_name", type=str, default='SMVTAN', help="model_name")
...
if args.model_name == 'SMVTAN':
    from SMVTAN import make_model
